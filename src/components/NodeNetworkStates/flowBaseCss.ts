 ...
 *
 * Generated by scripts/extract-flow-css.mjs from @xyflow/react 12.9.2 —
 ...
 */
export const FLOW_BASE_CSS = `/* this will be exported as base.css and can be used for a basic styling */
